...
# PG 연동에서 "돈이 맞는 코드"를 만들기까지 — 결제 장애복구 삽질기

> 결제 시스템에서 가장 중요한 건 "정상 동작하는 코드"가 아니라 "장애 상황에서도 돈이 맞는 코드"입니다.
> 이 글은 외부 PG사 연동 과정에서 겪은 동시성 버그, Circuit Breaker 설정 삽질, 그리고 "멱등성이 만능이 아니었다"는 깨달음을 기록합니다.
...
![Circuit Breaker 상태 전이 다이어그램](../assets/images/circuit-breaker-states.png)
...
![3중 방어 구조](../assets/images/defence.png)
...
## 3장. 두 번째 삽질 — Circuit Breaker 대기 시간
